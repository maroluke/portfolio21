<section id="references" class="z-50 relative">
    <div class="card-slider relative py-12 sm:pb-44">
            ...
            <div class="swiper-wrapper items-stretch sm:flex-col sm:mx-auto max-w-screen-md sm:gap-4">
                ...
                <div class="swiper-slide px-2 relative sm:px-0 sm:mx-auto xl:flex-1">
                    <div class="relative text-black bg-dirty-white rounded-2xl overflow-hidden border-gray-200 flex flex-col h-full transition-opacity duration-300 ease-in-out sm:border-none drop-shadow sm:grid sm:grid-cols-3 sm:p-0">
                        <div class="h-44 bg-cover bg-no-repeat image sm:bg-contain sm:bg-center sm:h-full sm:min-h-full sm:col-span-1" style="background-image: url({{ asset('media/big-o.png') }});"></div>
                        ...
                        <div class="reference-text backdrop-blur-xl rounded-b-2xl p-5 flex flex-col flex-grow justify-start relative sm:p-5 sm:col-span-2">
                            ...
                            <p class="text-tiny pb-2">@lang('In Zusam­men­arbeit mit den Gründern durfte ich einerseits die ')<a class="bg-yellow-200 px-1 hover:bg-yellow-400 text-black sm:hover:text-black rounded" href="https://generation-purpose.org" target="_blank">@lang('Online–Präsenz')</a>@lang(' entwickeln sowie eine digitale Plattform aufbauen, auf welcher die Facilitators (Mitarbeiter) und Kunden täglich arbeiten können.')</p>
                ...
                <div class="swiper-slide px-2 relative sm:px-0 sm:mx-auto xl:flex-1">
                    <div class="relative text-black bg-dirty-white rounded-2xl overflow-hidden border-gray-200 flex flex-col h-full transition-opacity duration-300 ease-in-out sm:border-none drop-shadow sm:grid sm:grid-cols-3 sm:p-0">
                        <div class="h-44 bg-cover bg-center image sm:h-full sm:min-h-full sm:col-span-1" style="background-image: url({{ asset('media/fundament-logo.png') }});"></div>
                ...
                <div class="swiper-slide px-2 relative sm:px-0 sm:mx-auto xl:flex-1">
                    <div class="relative text-black bg-dirty-white rounded-2xl overflow-hidden border-gray-200 flex flex-col h-full transition-opacity duration-300 ease-in-out sm:border-none drop-shadow sm:grid sm:grid-cols-3 sm:p-0">
                        <div class="h-44 bg-cover bg-right image sm:h-full sm:min-h-full sm:col-span-1" style="background-image: url({{ asset('media/coffaina-bottle.png') }});"></div>
                ...
                <div class="swiper-slide px-2 relative sm:px-0 sm:mx-auto xl:flex-1">
                    <div class="relative text-black bg-dirty-white rounded-2xl overflow-hidden border-gray-200 flex flex-col h-full transition-opacity duration-300 ease-in-out sm:border-none drop-shadow sm:grid sm:grid-cols-3 sm:p-0">
                        <div class="h-44 bg-cover bg-right image sm:h-full sm:min-h-full sm:col-span-1" style="background-image: url({{ asset('media/restaurant.png') }});"></div>
                        ...
                        <div class="reference-text backdrop-blur-xl rounded-b-2xl p-5 flex flex-col flex-grow justify-start relative sm:p-5 sm:col-span-2">
                            ...
                            @else
                                <p class="text-tiny py-6">@lang('naanu ist ein Restaurant, Take-Away und Delivery Service in Zürich welches mit dem Bedürfnis ihre Arbeits­prozesse zu digita­li­sieren an mich herangetreten ist.')</p>
                                <p class="text-tiny pb-2">@lang('Entstanden ist eine integrale Lösung bestehend aus ')<a class="bg-yellow-200 px-1 hover:bg-yellow-400 text-black sm:hover:text-black rounded" href="https://naanu.ch" target="_blank">@lang('Online– Shop')</a>@lang('Produkt­verwaltung, Belegdruck und Anbindung ans betriebsinterne Reservations- und Kassen­system sowie an die gängigen Auslieferungs­dienst­leister.')</p>
                            @endif
                        </div>
                    </div>
                </div>
