<section id="references" class="z-30 relative pt-10">
            
    <div class="card-slider">
        <div class="pb-8 relative z-50 flex justify-end overflow-hidden">
            <h2 class="px-3 sm:px-6 flex-grow text-white">@lang('Expertise')</h2>
            <p class="animate-swipe-x opacity-30 flex-shrink self-end sm:hidden"></p>
        </div>
                ...
                <div class="swiper-slide px-2 sm:px-0 sm:max-w-full sm:my-6">
                    <div class="rounded-2xl flex flex-col h-full overflow-hidden text-white transition-opacity duration-300 ease-in-out opacity-50 sm:opacity-100 sm:flex-row sm:rounded-none sm:overflow-visible">
                        ...
                        <div class="reference-text bg-white text-black p-5 flex flex-col flex-grow justify-start relative sm:py-0 sm:flex-1 sm:bg-transparent sm:text-white sm:pr-20">
                            ...
                            <p class="text-tiny pb-2">@lang('In Zusam­men­arbeit mit den Gründern durfte ich einerseits die ')<a class="bg-yellow-100 sm:bg-opacity-25 px-1 hover:bg-yellow-300 rounded" href="https://generation-purpose.org" target="_blank">@lang('Online–Präsenz')</a>@lang(' entwickeln sowie eine digitale Plattform aufbauen, auf welcher die Facilitators (Mitarbeiter) und Kunden täglich arbeiten können.')</p>
                    ...
                    <div class="rounded-2xl flex flex-col h-full overflow-hidden text-white transition-opacity duration-300 ease-in-out opacity-50 sm:opacity-100 sm:flex-row sm:rounded-none sm:overflow-visible">
                        ...
                        <div class="reference-text bg-white text-black p-5 flex flex-col flex-grow justify-start relative sm:py-0 sm:flex-1 sm:bg-transparent sm:text-white sm:pr-20">
                            ...
                            @else
                                ...
                                <p class="text-tiny pb-2">@lang('Entstanden ist eine ')<a class="bg-yellow-100 sm:bg-opacity-25 px-1 hover:bg-yellow-300 rounded" href="https://naanu.ch" target="_blank">@lang('integrale Lösung')</a>@lang(' bestehend aus Online– Shop, Produktverwaltung, Belegdruck und Anbindung ans betriebsinterne Reservations-, Kassen-, und Buchaltungssystem sowie an die gängigen Auslieferungsdienstleister.')</p>
                            @endif
                        </div>
                    </div>
                </div>
