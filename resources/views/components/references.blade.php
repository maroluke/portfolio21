<section id="references" class="z-30 relative sm:pt-10">
        ...
        <div class="swiper">
            <div class="swiper-wrapper items-stretch sm:flex-col sm:gap-6">
                ...
                <div class="swiper-slide px-2 sm:px-0 sm:max-w-full sm:my-6">
                    <div class="rounded-2xl flex flex-col h-full overflow-hidden text-white transition-opacity duration-300 ease-in-out opacity-50 sm:opacity-100 sm:flex-row sm:rounded-none sm:overflow-visible">
                        <div class="image relative max-h-48 overflow-hidden flex items-center sm:flex-shrink sm:flex-1 sm:max-h-full sm:overflow-visible">
                            <img class="opacity-75 sm:self-start sm:rounded-r" src="{{ asset('media/webpage-fundament.png') }}" alt="Fundament Web Page">
                        </div>
                ...
                <div class="swiper-slide px-2 sm:px-0 sm:max-w-full sm:my-6">
                    <div class="rounded-2xl flex flex-col h-full overflow-hidden text-white transition-opacity duration-300 ease-in-out opacity-50 sm:opacity-100 sm:flex-row sm:rounded-none sm:overflow-visible">
                        <div class="image relative max-h-48 overflow-hidden flex items-center sm:flex-shrink sm:flex-1 sm:max-h-full sm:overflow-visible">
                            <img class="opacity-75 sm:self-start sm:rounded-r" src="{{ asset('media/coffaina-bottle.png') }}" alt="Coffaina Bottle">
                        </div>
                        ...
                        <div class="reference-text bg-white text-black p-5 flex flex-col flex-grow justify-start relative sm:py-0 sm:flex-1 sm:bg-transparent sm:text-white sm:pr-20">
                            ...
                            <p class="font-bolder pb-2">@lang('In einem desing-sprint-workshop in Berlin konnte ich mit dem Kunden den ')<a class="bg-yellow-100 sm:bg-opacity-25 px-1 hover:bg-yellow-300 rounded" href="http://coffaina.com" target="_blank">@lang('digitalen Auftritt')</a> @lang(' entwickeln und diesen in einem zweiten Schritt umsetzen.')</p>
                ...
                <div class="swiper-slide px-2 sm:px-0 sm:max-w-full sm:my-6">
                    <div class="rounded-2xl flex flex-col h-full overflow-hidden text-white transition-opacity duration-300 ease-in-out opacity-50 sm:opacity-100 sm:flex-row sm:rounded-none sm:overflow-visible">
                        <div class="image relative max-h-48 overflow-hidden flex items-center sm:flex-shrink sm:flex-1 sm:max-h-full sm:overflow-visible">
                            <img class="opacity-75 sm:self-start sm:rounded-r" src="{{ asset('media/restaurant.png') }}" alt="Working at naanu restaurant">
                        </div>
                        ...
                        <div class="reference-text bg-white text-black p-5 flex flex-col flex-grow justify-start relative sm:py-0 sm:flex-1 sm:bg-transparent sm:text-white sm:pr-20">
                            ...
                            @if (App::isLocale('zh'))
                                <p class="font-bolder py-6">naanu 是苏黎世的一家餐厅，提供外卖和送餐服务，它向我提出了建立新<a class="bg-yellow-100 sm:bg-opacity-25 px-1 hover:bg-yellow-300 rounded" href="https://naanu.ch" target="_blank">数字业务</a>的需求。</p>
                            ...
                            @else
                                ...
                                <p class="font-bolder pb-2">@lang('Entstanden ist eine ')<a class="bg-yellow-100 sm:bg-opacity-25 px-1 hover:bg-yellow-300 rounded" href="https://naanu.ch" target="_blank">@lang('integrale Lösung')</a>@lang(' mit Anbindung ans betriebsinterne Reservations-, Kassen-, und Buchaltungssystem sowie an die gängigen Auslieferungsdienstleister.')</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide px-2 sm:px-0 sm:max-w-full sm:my-6">
                    <div class="rounded-2xl flex flex-col h-full overflow-hidden text-white transition-opacity duration-300 ease-in-out opacity-50 sm:opacity-100 sm:flex-row sm:rounded-none sm:overflow-visible">
                        <div class="image relative max-h-48 overflow-hidden flex items-center sm:flex-shrink sm:flex-1 sm:max-h-full sm:overflow-visible">
                            <img class="opacity-75 sm:self-start sm:rounded-r" src="{{ asset('media/desktop.png') }}" alt="Desktop">
                        </div>
