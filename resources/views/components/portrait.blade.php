<section id="portrait" class="px-6 py-10 z-20 relative max-w-lg mx-auto">
    <div class="flex gap-2 justify-between">
        ...
        <div class="flex flex-col flex-shrink justify-between sm:justify-start sm:gap-2">
                ...
                <a href="https://www.instagram.com/maroluke/" target="_blank" class="icon-button bg-white bg-opacity-10 rounded-xl p-3"><x-icon-logo-instagram /></a>
                <a href="https://unsplash.com/@maroluke" target="_blank" class="icon-button bg-white bg-opacity-10 rounded-xl p-3"><x-icon-logo-unsplash /></a>
                <a href="https://soundcloud.com/maroluke" target="_blank" class="icon-button bg-white bg-opacity-10 rounded-xl p-3"><x-icon-logo-soundcloud /></a>
        </div>
    </div>
</section>